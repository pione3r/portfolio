  ...
  return (
    <>
      <section id="skills-mobile" className="skills-conteiner w-full h-fit bg-blue-900 flex flex-col items-center gap-10">
        ...
        <div className="skills-container w-fit h-fit flex flex-col justify-center gap-10 mt-10">
          <div className="skills-item-1 skills-item front-end w-fit h-fit bg-white rounded-2xl flex flex-col justify-center gap-10 mx-16">
            <div
          ...
          <div className="skills-item-2 flex flex-col gap-10 mx-16">
          ...
          <div className="skills-item-3 flex flex-col gap-10 mx-16">
          ...
          <div className="skills-item-4 mx-16">
            <div className="skills-item ver-control w-fit h-fit bg-white rounded-2xl flex flex-col justify-center gap-10">
              <div
                className="text-center text-3xl font-bold"
                style={{ color: "rgb(29, 78, 216)" }}
